-- Fix Row Level Security (RLS) for all public tables - CORRECTED VERSION
...
-- 3. Create policies for combats table (using correct column names)
...
-- 5. Create policies for player_inventory table
...
-- 6. Create policies for weekly_champions table
...
-- 7. Create policies for user_equipment table
...
-- 8. Create policies for users table (if not already exists)
