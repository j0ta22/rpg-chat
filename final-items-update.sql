...
('Brutal War Axe', 'Savage two-handed axe', 'weapon', 'epic', '{"attack":2,"speed":-1}', 85, '/Items Pack/weapons/epic/brutal_war_axe.png', 12, 'weapon'),
...
('Kris Dagger', 'Mystical wavy dagger', 'weapon', 'epic', '{"attack":3,"speed":4}', 70, '/Items Pack/weapons/epic/kris_dagger.png', 12, 'weapon'),
...
('Excalibur', 'The legendary sword of kings', 'weapon', 'legendary', '{"attack":5,"speed":3,"health":50}', 150, '/Items Pack/weapons/legendary/excalibur.png', 16, 'weapon'),
('Dragon Slayer', 'Ultimate dragon-slaying weapon', 'weapon', 'legendary', '{"attack":6,"speed":2,"health":60}', 160, '/Items Pack/weapons/legendary/dragon_slayer.png', 16, 'weapon'),
('Warlord Battle Axe', 'Axe of the greatest warlord', 'weapon', 'legendary', '{"attack":4,"speed":1,"health":40}', 155, '/Items Pack/weapons/legendary/warlord_battle_axe.png', 16, 'weapon'),
('Molten War Mace', 'Mace forged in dragon fire', 'weapon', 'legendary', '{"attack":4,"speed":0,"health":45}', 145, '/Items Pack/weapons/legendary/molten_war_mace.png', 16, 'weapon'),
